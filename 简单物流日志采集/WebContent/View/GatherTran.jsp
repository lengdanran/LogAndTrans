...
<head>
<title>Be System | GatherTrans</title>
<meta charset="UTF-8">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                        	...
                        	<form id="basic-form" method="post" novalidate  action="GatherTransServlet" >
                                <div class="form-group">
	                                <div class="row clearfix">
	                                	<div class="col-lg-6 col-md-12">
	                                    	<label>物流ID</label>
	                                    	<input type="text" name="TransID" class="form-control" id="inputEmail3" placeholder="ID" required="" aria-required="true">
	                                 	</div>
	                                	<div class="col-lg-6 col-md-12">
	                                    	<label>目的地</label>
	                                    	<input type="text" name="Destination" class="form-control" id="inputPassword3" placeholder="目的地"  required="" aria-required="true">
	                                 	</div>
	                               </div>
                                </div>
                                ...
                                <div class="form-group">
	                                <div class="row clearfix">
	                                	<div class="col-lg-6 col-md-12">
	                                    	<label>经手人</label>
	                                    	<input type="text" name="Handler" class="form-control"  id="Address"  placeholder="经手人"  required="" aria-required="true">
	                                 	</div>
	                                	<div class="col-lg-6 col-md-12">
	                                		<label>收货人</label>
		                                    <input type="text" name="Receiver" class="form-control"  id="Address"  placeholder="收货人"  required="" aria-required="true">
                                        </div>
	                               </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>当前采集的物流数据表<small>截止到<%out.println(new SimpleDateFormat("yyyy年MM月dd日kk:mm:ss").format(new Date()));  %></small></h2>
                            <ul class="header-dropdown dropdown">
                            ...
                            <div class="table-responsive">
								...
								<tfoot>
									...
									<%
										...
										if(session.getAttribute("TransRecord")!=null){

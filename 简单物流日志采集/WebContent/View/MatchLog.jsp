...
<head>
<title>Be System | MatchLog</title>
<meta charset="UTF-8">
    ...
    <div id="main-content">
        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>当前匹配的日志数据表<small>截止到<%out.println(new SimpleDateFormat("yyyy年MM月dd日kk:mm:ss").format(new Date()));  %></small></h2>
                            <ul class="header-dropdown dropdown">
                            ...
                            <div class="table-responsive">
								...
								<tfoot>
									...
									<%
										...
										if(session.getAttribute("MatchLogs")!=null){
